  ...
  return (
    <section className={styles.container}>
      ...
      <div className="box">
        ...
        <Image className={styles.img} img="/img/logos/applydesign_black.png" alt="ApplyDesign logo" />
        ...
        <Image className={styles.img} img="/img/logos/ador.png" alt="AdOr logo" />
        <Image className={styles.img} img="/img/logos/eyecontrol_black.svg" alt="EyeControl logo" />
        <Image className={styles.img} img="/img/logos/firmus_black.png" alt="Firmus logo" />
        ...
        <Image className={styles.img} img="/img/logos/medhub_black.png" alt="MedHub logo" />
      </div>
    </section>
  );
}
